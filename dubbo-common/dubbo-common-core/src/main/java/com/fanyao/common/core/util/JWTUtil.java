package com.fanyao.common.core.util;
...
public class JWTUtil {
     ...
     */
    public static String getToken(Map<String, String> map, Integer expires) throws JwtException {
     ...
     * @param map 数据正文
     */
    public static String getToken(Map<String, String> map) throws JwtException {
     ...
     */
    private static String confoundPayload(String token) throws JwtException {
        //分割token
     ...
     */
    private static String deConfoundPayload(String token) throws JwtException {
        //分割token
        String[] split = token.split("\\.");
        //如果token不符合规范
        if (split.length != DEFAULT_TOKEN_SIZE) {
