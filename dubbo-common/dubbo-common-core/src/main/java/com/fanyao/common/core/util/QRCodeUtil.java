...
public class QRCodeUtil {
    ...
    public static BufferedImage createQRCodeWithLogo(String data, String charset, Map<EncodeHintType, ?> hint,
        ...
        try {
            ...
            BufferedImage combined = new BufferedImage(height, width, BufferedImage.TYPE_BYTE_BINARY);
            Graphics2D g = (Graphics2D) combined.getGraphics();
            g.drawImage(qrcode, 0, 0, null);
            g.setComposite(AlphaComposite.getInstance(AlphaComposite.DST_OVER, 1f));
